...
editUserBook = async function(id, bookName){
    var bookList = await userModel.findById(id).map(x=>{ return x.books});
...
module.exports = {addUser, getUser, getUserTable, getUserFree, getUserCount, getUserById, editUser, editUserBook, deleteUser, deleteUserBook, postAdmin}
